...
const SignUp = (props) => {
  return (
    <div className="sign-up-container">
      <Helmet>
        <title>sign-up - Far Off Popular Locust</title>
        <meta property="og:title" content="sign-up - Far Off Popular Locust" />
      </Helmet>
      <div className="sign-up-container1">
        <div className="sign-up-feature-card">
          <h2 className="sign-up-text">Create an account</h2>
          <input
            type="text"
          ...
          <div className="sign-up-container2">
            ...
            <span className="sign-up-text1">or Sign in with</span>
            <div className="sign-up-container3">
              <button type="button" className="sign-up-button1 button">
                <svg
        ...
        <img alt="image" src="/image%209-1500h.png" className="sign-up-image" />
      </div>
    </div>
  )
}
